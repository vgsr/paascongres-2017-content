...
<?php if ( paco2017_bp_is_user_enrolled() ) : ?>
	...
	<p><?php printf( __( 'Yes! %s will be attending the conference!', 'paco2017-content' ), bp_get_user_firstname() ); ?></p>

	<?php if ( ! paco2017_is_user_enrolled() ) : ?>

	<p><?php printf( __( "So you haven't decided yet whether you will attend the conference? Go ahead, ask %s what is so great about going to this event!", 'paco2017-content' ) ); ?></p>
...
<?php else : ?>
	...
	<p><?php printf( __( '%1$s is not yet enrolled. Since you have already decided to attend the conference, perhaps you can persuade %1$s to join you. If you need any help in winning this person over, here are some tips to assist you:', 'paco2017-content' ), bp_get_user_firstname() ); ?></p>

	<?php else : ?>

	<p><?php printf( __( '%1$s is not yet enrolled. Would you happen to know whether %1$s is interested in the theme of the conference or prefers to be in the company of 200+ amicae amicique? Perhaps you can decide to join us together. Here are some tips that may win you over:', 'paco2017-content' ), bp_get_user_firstname() ); ?></p>
